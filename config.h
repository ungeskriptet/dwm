...
static const char *fonts[]          = { "monospace:size=10", "Material Design Icons:size=15:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ Mod4Mask|ControlMask,         XK_Print,  spawn,          SHCMD("maim | xclip -selection clipboard -t image/png && notify-send \"Screenshot copied to clipboard.\"") },
	{ Mod4Mask|ShiftMask|ControlMask,XK_Print, spawn,          SHCMD("maim -s | xclip -selection clipboard -t image/png && notify-send \"Cropped screenshot copied to clipboard.\"") },
